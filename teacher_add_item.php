...
if(isset($_GET["class_id"])) {
    ...
    if(isset($_POST["addItem"])) {
        ...
        if(preg_match("/^([a-zA-Z' ]+)$/",$_POST['itemTitle'])){
            $itemTitle = $_POST['itemTitle'];
    	}
    	
    	if(preg_match("/^([a-zA-Z' ]+)$/",$_POST['itemContent'])){
        ...
        <div id="c-class-form">
            ...
            <div>
                ...
                <form method="post" form>
                    ...
                    <textarea id="class-description" name="itemContent" placeholder="Item Content" required></textarea>
